...
public class PoseSubsystem extends SubsystemBase {
    ...
    private static final List<Pose3d> targetPoses = Collections.unmodifiableList(List.of(
        new Pose3d(AutonomousConstants.APRIL_1_X, AutonomousConstants.APRIL_1_Y, AutonomousConstants.APRIL_Z, new Rotation3d(0, 0, Units.degreesToRadians(180))),
        new Pose3d(AutonomousConstants.APRIL_2_X, AutonomousConstants.APRIL_2_Y, AutonomousConstants.APRIL_Z, new Rotation3d(0, 0, Units.degreesToRadians(180)))
    ));
